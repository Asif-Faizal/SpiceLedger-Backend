...
func (client *ControlClient) GetMerchantInfo(ctx context.Context, request *pb.GetMerchantInfoRequest) (*pb.GetMerchantDetailsResponse, error) {
	response, err := client.client.GetMerchantInfo(ctx, request)
	if err != nil {
		return nil, err
	}
	return response, nil
